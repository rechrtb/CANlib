...
NamedEnum(EventType, uint8_t, main_board_power_fail, expansion_reconnect, expansion_timeout, heater_fault, driver_error, filament_error, driver_stall, driver_warning, mcu_temperature_warning, overvoltage_warning);
